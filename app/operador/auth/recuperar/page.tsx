...
import { Mail, ArrowLeft, Loader2, CheckCircle, ArrowRight, Smartphone } from "lucide-react"

export default function OperadorRecuperarPage() {
              ...
              {!emailSent ? (
                ...
                >
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardDescription>
                      Te enviaremos un enlace para restablecer tu contrasena de operador
                    </CardDescription>
                  </CardHeader>
